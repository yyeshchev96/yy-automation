  ...
  return (
    <>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-2 pt-8 pb-8 md:space-y-5">
          <h1 className="text-5xl font-extrabold leading-10 tracking-tight text-gray-900 dark:text-gray-100 sm:text-5xl md:text-6xl md:leading-14">
        ...
        <ul>
          ...
          {displayPosts.map((post) => {
            ...
            const postUrl = externalUrl ? externalUrl : `/${path}`
            return (
